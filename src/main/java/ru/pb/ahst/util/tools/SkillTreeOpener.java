...
public class SkillTreeOpener extends Item {
    public SkillTreeOpener(Properties pProperties) {
        super(pProperties);
    }
    ...
    public static void openSkillTreeScreen(InteractionHand hand) {
        Minecraft.getInstance().setScreen(new SkillTreeScreen(Component.empty()));
    }
}
